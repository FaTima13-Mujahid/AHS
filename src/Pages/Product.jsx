...
const Product = () => {
  ...
  const products = [
    ...
    {
      image:  require("../img/products/msplates.jpg"),
       title: "MS Plates",
    ...
    links: "/Chequeredplates"
        ...
        {
      image:
        require( "../img/products/boiler.jpeg"),
      title: "Boiler Plates",
    ...
    links: "/Boilerplates"
     ...
     {
      image: require ("../img/products/mspipes.jpg"),
       title: "MS Pipes",
     ...
     {
      image:  require("../img/products/cold.jpeg"),
     ...
     {
      image:  require("../img/products/gi.jpg"),
       title: "GI Pipe ",
      ...
      links: "/Gpipe"
       ...
       {
      image:  require("../img/products/tin.jpg"),
    ...
    {
      image:  require("../img/products/round.jpg"),
       title: "MS Round Bars",
      description: "Mill products include electrolytic tinplate, electrolytic chromium coated steel (also referred to as tin-free steel or TFS), and black plate, the uncoated steel. About 90% of tin mill products made in the world are used by the container industry in the manufacture of cans, ends, and closures for the food and beverage industry. ",
      links: "/RoundBars"
     ...
     {
      image:  require("../img/products/deformed.jpeg"),
      ...
      links: "/DeformedBars"
        ...
        {
      image:  require("../img/products/rail.jpeg"),
       title: "MS Rail",
      ...
      {
      image:  require("../img/products/flat.jpeg"),
      title: "MS Flat",
    ...
    {
      image:  require("../img/products/ppgi.png"),
      ...
      {
      image:  require("../img/products/color.jpg"),
 ...
 links: "/Colorcoilsheets "
        ...
        {
      image:
         require("../img/products/beam.jpeg"),
      title: "H Beam, I Beam",
     ...
     links: "/Hbeam"
      ...
      {
      image:  require("../img/products/zsection.jpg"),
       title: "Z Section",
