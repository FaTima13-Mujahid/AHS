   ...
   <main>
		...
		<section className="button-area">
			<div className="container box_1170 border-top-generic">
				...
				<div className="button-group-area mt-40">
					<Link to="#" className="genric-btn default circle arrow">Default<span className="lnr lnr-arrow-right"></span></Link>
					<Link to="#" className="genric-btn primary circle arrow">Primary<span className="lnr lnr-arrow-right"></span></Link>
					<Link to="#" className="genric-btn success circle arrow">Success<span className="lnr lnr-arrow-right"></span></Link>
					<Link to="#" className="genric-btn info circle arrow">Info<span className="lnr lnr-arrow-right"></span></Link>
					<Link to="#" className="genric-btn warning circle arrow">Warning<span className="lnr lnr-arrow-right"></span></Link>
					<Link to="#" className="genric-btn danger circle arrow">Danger<span className="lnr lnr-arrow-right"></span></Link>
				</div>
				<div className="button-group-area mt-10">
					...
					<div className="progress-table-wrap">
						<div className="progress-table">
							...
							<div className="table-row">
								...
								<div className="percentage">
									<div className="progress">
										<div className="progress-bar color-2" role="progressbar" style={{width: "30%"}}
							...
							<div className="table-row">
								...
								<div className="percentage">
									<div className="progress">
										<div className="progress-bar color-3" role="progressbar" style={{width: "55%"}}
							...
							<div className="table-row">
								...
								<div className="percentage">
									<div className="progress">
										<div className="progress-bar color-4" role="progressbar" style={{width: "60%"}}
							...
							<div className="table-row">
								...
								<div className="percentage">
									<div className="progress">
										<div className="progress-bar color-5" role="progressbar" style={{width: "40%"}}
							...
							<div className="table-row">
								...
								<div className="percentage">
									<div className="progress">
										<div className="progress-bar color-7" role="progressbar" style={{width: "30%"}}
											aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
									</div>
								</div>
							</div>
							<div className="table-row">
								...
								<div className="percentage">
									<div className="progress">
										<div className="progress-bar color-8" role="progressbar" style={{width: "60%"}}
											aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
									</div>
								</div>
							</div>
							...
							<form action="#">
								...
								<div className="input-group-icon mt-10">
									...
									<input type="text" name="address" placeholder="Address" onfocus="this.placeholder = ''"
										onblur="this.placeholder = 'Address'" required className="single-input"/>
								</div>
								<div className="input-group-icon mt-10">
								...
								<div className="mt-10">
									<textarea className="single-textarea" placeholder="Message" onfocus="this.placeholder = ''"
